import 'dart:math';
import 'package:epub_app/widgets/minimal_book_info_bar.dart';
        ...
        children: [
          SizedBox(
            ...
            child: TabBar(
              ...
              tabs: [
                if (showDescription) const Tab(text: 'Mô tả'),
                if (showChapters) const Tab(text: 'Danh sách chương'),
              ],
            ),
          ),
          Expanded(
                  ...
                  child: Padding(
                    ...
                    child: TextButton(
                      ...
                      child: const SizedBox(
                        ...
                        child: Center(
                          child: Text(
                            //widget.book.savedData == null ? "Download" : "Đọc",
                            "Đọc",
                            style: TextStyle(
                              fontSize: 18,
                            ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          "Viết bởi ${widget.book.getAuthors()}",
