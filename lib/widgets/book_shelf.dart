...
import 'package:epub_app/pages/book_info.dart';
...
class BookShelf extends StatefulWidget {
  const BookShelf({
    ...
    required this.onUpdateNameBookShelves,
  ...
  final void Function() onUpdateNameBookShelves;
...
class _BookShelfState extends State<BookShelf> {
  ...
  final ValueNotifier<double> notifier = ValueNotifier<double>(1);
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        InkWell(
          onLongPress: widget.onPressDelete,
          onDoubleTap: widget.onUpdateNameBookShelves,
                  ...
                  return SizedBox(
                    ...
                    child: PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final heroTag = "book3d-${book.savedData!.bookId}-${widget.shelf.name}";
