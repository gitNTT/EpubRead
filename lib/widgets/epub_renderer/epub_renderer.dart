...
EpubStyleThemes _getThemeFromJson(dynamic json) {
  if (json == 'dark') {
    return EpubStyleThemes.dark;
  } else {
    return EpubStyleThemes.light;
  }
}
...
class EpubStyleProperties {
  ...
  EpubStyleProperties.fromJson(Map<String, dynamic> json)
      : margin = EpubMargin.fromJson(json['margin']),
        ...
        isHorVerMode= json['isHorVerMode'],
        theme = _getThemeFromJson(json['theme']);
        //theme = enumFromIndex(
        //   EpubStyleThemes.values,
        //   json['theme'],
        //   def: EpubStyleThemes.light,
        // );
  //theme = json['theme'] == 'dark' ? EpubStyleThemes.dark : EpubStyleThemes.light;
...
class EpubRendererController {
  ...
  // EpubStyleProperties sharedStyle = EpubStyleProperties(
  //   margin: EpubMargin(
  //     side: 28,
  //     top: 50,
  //     bottom: 20,
