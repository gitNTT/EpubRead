      ...
      child: Row(
        ...
        children: [
          _TextInfo(
              ...
              await showDialog(
                ...
                builder: (context) => AlertDialog(
                  content: Column(
                    ...
                    children: [
                      Text("Đánh giá ${widget.book.name}"),
            ...
            topic: "Đánh giá",
            value:
                "${removeLeadingZeros(widget.book.savedData?.data.rating?.toString() ?? "*")}/5",
          ),
          const _Separator(),
          _TextInfo(topic: "Trang", value: widget.book.pages.toString()),
          const _Separator(),
          const _TextInfo(topic: "Ngôn ngữ", value: "VIE"),
        ],
      ),
    );
  }
